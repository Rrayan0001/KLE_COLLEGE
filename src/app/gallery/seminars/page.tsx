...
const sidebarLinks = [
  ...
  { name: "Seminar & Conferences", href: "/gallery/seminars", active: true },
      ...
      <div className="space-y-8">
        <div>
          ...
          <h2 className="text-xl md:text-2xl font-extrabold text-slate-800 uppercase tracking-wide">
            UGC Funded & Self-Funded Conferences
          </h2>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-brand-maroon text-white text-xs font-bold tracking-wide uppercase">
                  ...
                  <th className="py-3 px-4">Conference Topic</th>
