...
export default function Navbar() {
  ...
  const navLinks = [
    { name: "HOME", href: "/" },
    {
      ...
      href: "/management",
      sublinks: [
        { name: "KLE History", href: "/management" },
        { name: "KLE Society", href: "/management" },
        { name: "Chairman's Message", href: "/management" },
        { name: "Board Members", href: "/management" },
        { name: "Local Governing Body", href: "/management" },
      ],
    },
    {
      name: "ABOUT US",
      href: "/about",
      sublinks: [
        { name: "Donor of SPDDS", href: "/about" },
        { name: "About College", href: "/about" },
        { name: "Vision & Mission", href: "/about" },
        { name: "Our Principal", href: "/about" },
        { name: "Our Staff", href: "/about" },
    ...
    },
    {
      ...
      href: "/iqac",
      sublinks: [
        { name: "Composition", href: "/iqac" },
        { name: "Steering Committee", href: "/iqac" },
        { name: "Code of Conduct", href: "/iqac" },
        { name: "Code of Ethics", href: "/iqac" },
        { name: "Academic Plan of Action", href: "/iqac" },
        { name: "Minutes of Meeting", href: "/iqac" },
        { name: "Affiliation Details", href: "/iqac" },
        { name: "Quality Policy", href: "/iqac" },
      ],
    },
    {
      name: "NAAC",
      ...
      sublinks: [
        ...
        { name: "AISHE", href: "/naac" },
        { name: "Criterion Wise Details", href: "/naac" },
        { name: "RTI Act", href: "/naac" },
        { name: "Undertaking", href: "/naac" },
      ],
    },
    {
      name: "PROGRAMS",
      href: "/programs",
      sublinks: [
        { name: "B.A", href: "/programs" },
        { name: "B.COM", href: "/programs" },
        { name: "B.Sc", href: "/programs" },
        { name: "M.Com", href: "/programs" },
        { name: "BCA", href: "/programs" },
        { name: "ITEP", href: "/itep" },
        { name: "Program Outcomes", href: "/programs" },
        { name: "Best Practice", href: "/programs" },
        { name: "Institutional Distinctiveness", href: "/programs" },
        { name: "S S S", href: "/programs" },
      ],
    },
    {
      name: "INFRASTRUCTURE",
      href: "/infrastructure",
      sublinks: [
        { name: "Office", href: "/infrastructure" },
        { name: "Support Facilities", href: "/infrastructure" },
        { name: "Library", href: "/infrastructure" },
        { name: "Hostel", href: "/infrastructure" },
        { name: "ClassRooms", href: "/infrastructure" },
        { name: "Multi-Purpose Gymnasium", href: "/infrastructure" },
        { name: "Labs", href: "/infrastructure" },
      ],
    },
    {
      name: "SUPPORTING SECTIONS",
      href: "/supporting-sections",
      sublinks: [
        { name: "Sports & Culture Activities", href: "/supporting-sections" },
        { name: "Scholarships", href: "/supporting-sections" },
        { name: "Research Policy", href: "/supporting-sections" },
      ],
    },
    {
      name: "STUDENT CORNER",
      href: "/student-corner",
      sublinks: [
        { name: "Admission", href: "/student-corner" },
        { name: "Student Strength", href: "/student-corner" },
        { name: "Syllabus", href: "/student-corner" },
        { name: "Academic Calendar", href: "/student-corner" },
        { name: "Student Research", href: "/student-corner" },
        { name: "Student Support Facilities", href: "/student-corner" },
        { name: "NSS", href: "/student-corner" },
      ],
    },
    {
      name: "MEDIA",
      ...
      sublinks: [
        ...
        { name: "Seminar & Conference (UGC Funded & Self-Funded)", href: "/gallery" },
        { name: "Notifications", href: "/gallery" },
      ],
    },
