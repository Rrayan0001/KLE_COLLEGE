        ...
        <div className="bg-slate-50 border border-slate-100 p-8 rounded-2xl space-y-6 text-slate-600 leading-relaxed text-justify text-sm md:text-base">
          ...
          <div className="pt-4">
            <a
              ...
              className="btn-center-fill btn-center-fill-maroon inline-flex items-center gap-2 text-white font-bold text-sm uppercase px-6 py-3.5 rounded-xl shadow-md"
            >
