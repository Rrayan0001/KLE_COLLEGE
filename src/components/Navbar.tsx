...
export default function Navbar() {
  ...
  const navLinks = [
    { name: "HOME", href: "/" },
    {
      ...
      href: "/management",
      sublinks: [
        { name: "Board of Management", href: "/management" },
        { name: "President Message", href: "/management" },
      ],
    },
    {
      name: "ABOUT US",
      href: "/about",
      sublinks: [
        { name: "About KLE Society", href: "/about" },
    ...
    },
    {
      ...
      sublinks: [
        { name: "SSR", href: "/naac" },
        { name: "Peer Team Report", href: "/naac" },
        { name: "Best Practices", href: "/naac" },
      ],
    },
    {
      name: "PROGRAMS",
      href: "/programs",
      sublinks: [
        { name: "BA", href: "/programs#ba" },
        { name: "BSc", href: "/programs#bsc" },
        { name: "BCom", href: "/programs#bcom" },
      ],
    },
    {
      name: "INFRASTRUCTURE",
      href: "/infrastructure",
      sublinks: [
        { name: "Campus", href: "/infrastructure" },
    ...
    },
    {
      ...
      sublinks: [
        { name: "NSS", href: "/supporting-sections" },
        { name: "NCC", href: "/supporting-sections" },
        { name: "Red Cross", href: "/supporting-sections" },
      ],
    },
    {
      name: "STUDENT CORNER",
      href: "/student-corner",
      sublinks: [
        { name: "Admissions", href: "/student-corner" },
        { name: "Results", href: "/student-corner" },
        { name: "Scholarships", href: "/student-corner" },
      ],
    },
    {
      name: "MEDIA",
